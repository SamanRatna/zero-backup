  ...
  req.onreadystatechange = function()
  {
    if(this.readyState == 4 && this.status == 200) {
      ...
      if(response != null){
            ...
            document.getElementsByClassName("range")[0].innerHTML = Math.round(est_range);
            document.getElementsByClassName("speedMain")[0].innerHTML = veh_speed;
            document.getElementsByClassName("powerMain")[0].innerHTML = Math.round(motor_vel*torque_act*2*Math.PI/(60*746)*10);
            document.getElementsByClassName("rangeMain")[0].innerHTML = Math.round(est_range);
            document.getElementsByClassName("tripMain")[0].innerHTML = odometer - 20;
            document.getElementsByClassName("odoMain")[0].innerHTML = odometer;
            
            // Stand check
            
            if (stand == 'down' && alert_sent == 0) {
                alert("You're missing something important ;)")
                alert_sent = 1
            }
            
            // Display peripheral signals
            if (lturn == 1) {
                document.getElementsByClassName("leftTurn")[0].src = "static/images/leftArrowOn.png";
            } else {
                document.getElementsByClassName("leftTurn")[0].src = "static/images/leftArrowOff.png";
            }
            if (rturn == 1) {
                document.getElementsByClassName("rightTurn")[0].src = "static/images/rightArrowOn.png";
            } else {
                document.getElementsByClassName("rightTurn")[0].src = "static/images/rightArrowOff.png";
            }
            if (hibeam == 1) {
                document.getElementsByClassName("beam")[0].src = "static/images/highBeamOn.png";
            } else {
                document.getElementsByClassName("beam")[0].src = "static/images/highBeamOff.png";
            }
            
            
            // Display standby screen vs drive screen
            if (mode == 'standby') {
                var slides = document.getElementsByClassName("mySlides");
                ...
                // Display mode selection in drive mode
                if (mode == 'suste') {
                    document.getElementsByClassName("modeMain")[0].src = "static/images/mode1.png";
                } else if (mode == 'thikka') {
                    document.getElementsByClassName("modeMain")[0].src = "static/images/mode2.png";
                } else if (mode == 'babbal') {
                    document.getElementsByClassName("modeMain")[0].src = "static/images/mode3.png";
                } else if (mode == 'reverse') {
                    document.getElementsByClassName("modeMain")[0].src = "static/images/reverse.png";    
                }
            }
      }
    }
...
//setInterval(function () {
    //document.getElementsByClassName("range")[0].innerHTML = Math.floor((Math.random() * 100) + 1);
